        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/orders/ai-order"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/orders/ai-order' && 'text-white'
                              } `}
                            >
                              Order with AI
                            </Link>
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/doors/900doors"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/doors/900doors' && 'text-white'
                              } `}
                            >
                              900mm Doors
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/doors/1000doors"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/doors/1000doors' && 'text-white'
                              } `}
                            >
                              1000mm Doors
                            </Link>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/hardware' || pathname.includes('hardware')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/hardware/doorfurniture"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/hardware/doorfurniture' &&
                                'text-white'
                              }`}
                            >
                              Door Furniture
                          ...
                          <li>
                            <Link
                              href="/hardware/generalhardware"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/hardware/generalhardware' &&
                                'text-white'
                              }`}
                            >
                              General Hardware
                          ...
                          <li>
                            <Link
                              href="/hardware/doorclosers"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/hardware/doorclosers' &&
                                'text-white'
                              }`}
                            >
                              Door Closers
